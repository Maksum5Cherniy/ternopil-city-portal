export const uk = {
  ...
  home: {
    ...
    heroMeta: "Перший етап: архітектура, дизайн-система, навігація, теми та SEO-фундамент.",
    latestNews: "Останні новини",
    popularPlaces: "Популярні заклади",
    ...
    businessBlock: {
      ...
      description:
        "Кабінет власника дає змогу керувати закладом, фото, меню, акціями, подіями, відповідями на відгуки та статистикою.",
      action: "Кабінет власника",
    },
    listingBlock: {
      title: "Міська барахолка",
      description:
        "Оголошення проходитимуть модерацію, матимуть обмеження фото, статуси, скарги та контакти без внутрішнього чату.",
      action: "Додати оголошення",
    },
  },
  pages: {
    notFoundTitle: "Сторінку не знайдено",
    notFoundDescription: "Посилання може бути застарілим або розділ ще не відкритий.",
  ...
  auth: {
    ...
    loginTitle: "Увійти",
    loginDescription: "Вхід потрібен для кабінету, оголошень, відгуків і заявок власника закладу.",
    firebaseMissing:
      "Firebase ще не налаштований. Додайте змінні з .env.example у .env.local і перезапустіть сервер.",
    profileCreated: "Профіль створено. Тепер можна перейти в особистий кабінет.",
  ...
  admin: {
    ...
    accessNote:
      "На наступному етапі доступ сюди буде закритий server-side перевіркою ролі admin. Зараз сторінка показує структуру панелі.",
  },
} as const;
