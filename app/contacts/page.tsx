...
export const metadata: Metadata = {
  title: "Контакти",
  description:
    "Контакти команди міського порталу Тернополя для реклами, партнерства і модерації.",
};
...
const contactTopics = [
  {
    title: "Реклама",
    description:
      "Банери, промо-блоки, спецпроєкти та розміщення закладу на головній.",
    icon: Megaphone,
  },
  {
    title: "Заклади",
    description:
      "Заявка власника, адреса, контакти й виправлення даних у каталозі.",
    icon: Store,
  },
  {
    title: "Модерація",
    description:
      "Скарги, помилки в матеріалах, оголошеннях, відгуках або даних закладу.",
    icon: ShieldCheck,
  },
  {
    title: "Партнерство",
    description:
      "Міські добірки, перевірені анонси подій та інформаційні кампанії.",
    icon: BadgeCheck,
  },
];
  ...
  return (
    <section className="mx-auto w-full max-w-[980px] px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
      ...
      <p className="mt-5 max-w-3xl text-base leading-8 text-muted sm:text-lg">
        Для замовлення реклами, оновлення даних закладу, питань модерації або
        інших деталей звертайтеся до нас у Telegram.
      </p>
