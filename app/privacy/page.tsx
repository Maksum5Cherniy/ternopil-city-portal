  ...
  return (
    <section className="mx-auto w-full max-w-[840px] px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
      ...
      <div className="mt-6 grid gap-5 text-base leading-8 text-muted">
        <p>
          {SITE.title} обробляє дані користувачів для авторизації, публікації матеріалів, модерації,
          збереження обраного, сповіщень і захисту від зловживань.
        </p>
        <p>
        ...
        <p>
          Секретні ключі Firebase, службові облікові дані та приватні токени не зберігаються у
